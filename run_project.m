...
stokes_jcm(:,:,2) = jones_to_stokes(jones_mode_2_jcm);
stokes_pert = zeros(4,N,2);                                              % i=num of stokes parameters, j=numel(twist rates), k=modes
stokes_pert(:,:,1) = jones_to_stokes(jones_mode_1_pert);
stokes_pert(:,:,2) = jones_to_stokes(jones_mode_2_pert);
...
title(sprintf('1st polarization mode (blue) and 2nd polarization mode (red) from JCM'));
...
title(sprintf('1st polarization mode (blue) and 2nd polarization mode (red) from perturbation theory'));
